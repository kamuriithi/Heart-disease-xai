...
Chuka University · CDAM | MSc Applied Statistics
"""
    ...
    with tab2:
        ...
        for j, (fname, sv_col) in enumerate(zip(fn_ord, sv_ord.T)):
            ...
            ax_bs.scatter(sv_col, np.full_like(sv_col, j) + jitter,
                          c=colors_s, s=10, alpha=0.65, linewidths=0)
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    <div style='background:#1c2128;border:2px solid #f0883e;border-radius:12px;padding:20px 24px;'>
        ...
        <strong>Master of Science in Applied Statistics</strong> project at Chuka University (CDAM).
